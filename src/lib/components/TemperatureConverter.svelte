...
<div class="w-full lg:w-1/2 lg:pr-4">
    ...
    {#if isValidInput && result}
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div
                    class="card p-4 text-center {result.percentageDifference > 5
                        ? 'variant-filled-warning'
                        : 'variant-filled-success'}"
                >
                    <p class="text-xs opacity-80 mb-2">Percentage Difference</p>
                    <p class="text-xl font-bold mb-1">
                        {TemperatureConverter.formatTemperature(
    ...
    <div class="mt-6 p-4 bg-surface-100-800-token rounded-lg">
        <p class="text-sm text-surface-600-300-token">
            <strong>Tip:</strong> The approximation formula (F - 30) / 2 ≈ C is a
            quick mental calculation that works reasonably well for everyday temperatures.
            The percentage difference shows how accurate this approximation is compared
