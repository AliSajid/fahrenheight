...
<div class="container mx-auto px-4 py-16 flex flex-col items-center justify-center min-h-[70vh]">
    <div class="text-center space-y-6 max-w-2xl">
        ...
        <div class="flex gap-4 justify-center flex-wrap">
            ...
            <button onclick={() => history.back()} class="btn variant-ghost-surface">
                <ArrowLeft size={20} />
                <span>Go Back</span>
            </button>
        </div>
        ...
        {#if status === 404}
            <div class="card variant-ghost p-6 mt-8">
                ...
                <p class="text-surface-600-300-token">
                    This site is a simple temperature converter. Try visiting the <a
                        href="/"
                        class="anchor">home page</a
                    > to start converting temperatures.
                </p>
            </div>
        {/if}
    </div>
